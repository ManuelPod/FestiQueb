...
VALUES
(DEFAULT, 'Jean Tremblay', '514-123-4567', 'jean.tremblay@example.com', 3, 'audience.jpg'),
(DEFAULT, 'Marie Gagnon', '418-555-1234', 'marie.gagnon@example.com', 7, 'audience.jpg'),
(DEFAULT, 'Pierre Dubois', '514-987-6543', 'pierre.dubois@example.com', 4, 'audience.jpg'),
(DEFAULT, 'Sophie Lavoie', '514-555-7890', 'sophie.lavoie@example.com', 6, 'audience.jpg'),
(DEFAULT, 'Michel Bouchard', '819-321-7654', 'michel.bouchard@example.com', 9, 'audience.jpg'),
(DEFAULT, 'Isabelle Martin', '418-456-7890', 'isabelle.martin@example.com', 2, 'audience.jpg'),
(DEFAULT, 'Simon Fortin', '819-654-3210', 'simon.fortin@example.com', 8, 'audience.jpg'),
(DEFAULT, 'Nathalie Roy', '514-333-4444', 'nathalie.roy@example.com', 5, 'audience.jpg'),
(DEFAULT, 'Luc Deschênes', '418-222-3333', 'luc.deschenes@example.com', 1, 'audience.jpg'),
(DEFAULT, 'Caroline Bergeron', '418-777-8888', 'caroline.bergeron@example.com', 10, 'audience.jpg'),
(DEFAULT, 'Marc Gauthier', '514-111-2222', 'marc.gauthier@example.com', 3, 'audience.jpg'),
(DEFAULT, 'Catherine Leblanc', '418-999-8888', 'catherine.leblanc@example.com', 6, 'audience.jpg'),
(DEFAULT, 'François Tremblay', '418-333-4444', 'francois.tremblay@example.com', 7, 'audience.jpg'),
(DEFAULT, 'Martine Roy', '514-777-6666', 'martine.roy@example.com', 9, 'audience.jpg'),
(DEFAULT, 'Sylvain Gagné', '819-888-7777', 'sylvain.gagne@example.com', 4, 'audience.jpg'),
(DEFAULT, 'Julie Bergeron', '514-222-3333', 'julie.bergeron@example.com', 8, 'audience.jpg'),
(DEFAULT, 'Éric Dubé', '418-444-5555', 'eric.dube@example.com', 5, 'audience.jpg'),
(DEFAULT, 'Caroline Fortier', '819-666-7777', 'caroline.fortier@example.com', 2, 'audience.jpg'),
(DEFAULT, 'Patrick Tremblay', '514-999-8888', 'patrick.tremblay@example.com', 6, 'audience.jpg'),
(DEFAULT, 'Geneviève Lévesque', '418-111-2222', 'genevieve.levesque@example.com', 9, 'audience.jpg'),
(DEFAULT, 'Stéphane Bélanger', '819-555-6666', 'stephane.belanger@example.com', 3, 'audience.jpg'),
(DEFAULT, 'Annie Girard', '514-888-9999', 'annie.girard@example.com', 8, 'audience.jpg'),
(DEFAULT, 'Louis Tremblay', '418-777-9999', 'louis.tremblay@example.com', 0, 'audience.jpg'),
(DEFAULT, 'Sylvie Gagnon', '819-444-8888', 'sylvie.gagnon@example.com', 10, 'audience.jpg'),
(DEFAULT, 'Alexandre Dubois', '514-333-9999', 'alexandre.dubois@example.com', 7, 'audience.jpg'),
(DEFAULT, 'Valérie Lachance', '418-666-9999', 'valerie.lachance@example.com', 1, 'audience.jpg'),
(DEFAULT, 'Martin Fortin', '819-777-8888', 'martin.fortin@example.com', 5, 'audience.jpg'),
(DEFAULT, 'Nancy Tremblay', '514-555-3333', 'nancy.tremblay@example.com', 10, 'audience.jpg'),
(DEFAULT, 'Yves Gagné', '418-888-7777', 'yves.gagne@example.com', 4, 'audience.jpg'),
(DEFAULT, 'Isabelle Bélanger', '819-999-8888', 'isabelle.belanger@example.com', 6, 'audience.jpg');
